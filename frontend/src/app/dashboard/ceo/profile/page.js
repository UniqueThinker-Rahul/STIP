...
export default function ProfilePage() {
  ...
  // 🚨 THE FIX: Restored handleChange function for password inputs
  ...
  const handleEmailUpdate = async (e, isRemoval = false) => {
    ...
    try {
      const payload = { 
        ...
        notificationEmail: isRemoval ? null : notificationEmail 
      };
      
      const response = await api.patch('/users/notification-email', payload);
              ...
              <div className="flex flex-col gap-[16px]">
                ...
                <div className="flex gap-3 mt-[8px]">
                  <button 
                    ...
                    className="flex-1 py-[12px] bg-amber-500 text-[#0D2B55] rounded-[8px] text-[13px] font-[800] hover:bg-amber-400 shadow-sm disabled:opacity-50"
                  >
                  ...
                  {user.personalDetails?.notificationEmails?.[selectedRoleContext] && (
                    <button 
                      ...
                      className="px-4 py-[12px] bg-red-50 text-red-600 border border-red-200 rounded-[8px] text-[13px] font-[800] hover:bg-red-100 disabled:opacity-50"
                    >
                      Remove
                    </button>
                  )}
