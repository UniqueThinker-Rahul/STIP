...
router.post('/request-link', async (req, res) => {
  try {
    ...
    // 🚨 FIX: Updated the URL to point directly to your combined frontend page with the token as a query parameter
    const resetUrl = `${process.env.FRONTEND_URL || 'http://localhost:3000'}/ict-forgot-password?token=${rawToken}`;
